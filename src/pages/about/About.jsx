      ...
      <div className="container" id="aboutPageBox">
        <div id="aboutPageBoxCard">
          ...
          <div id="aboutPageBoxCardText">
            ...
            <p>
              <b>BuagoPula Properties Pvt Ltd</b> is a registered private company
              specializing in the construction and development industry.
              Established in 2010, we have been committed to
              delivering high-quality construction projects and exceptional
              service to our clients for over 10 years.
            </p>
          </div>
        </div>
